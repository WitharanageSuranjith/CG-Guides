...
const course01: Course = {
  ...
  overview: {
    image: {
      src: '/Website/wp2034563-cgi-wallpapers.jpg',
      alt: '3D Character Creation',
      width: 600,
      height: 400,
    },
    title: 'Learn the fundamentals of character creation',
    subtitle: 'An 8-week course focused on creating stronger environment paintings based on a narrative of the student s choice ',
    description:
