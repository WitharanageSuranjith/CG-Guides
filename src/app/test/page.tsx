...
const courseData = {
  ...
  studentResults: {
    ...
    studentWorks: [
      ...
      { id: 2, image: '/Website/jarold-sng-blend-demo-01-jsd-v02.jpg', title: 'Sci-Fi Scene', student: 'John Walker' },
      ...
      { id: 4, image: '/Website/flycat-fly-rend-f.jpg', title: 'Anime Character', student: 'David Liu' },
      { id: 5, image: '/Website/dmitry-osipenko-004.jpg', title: 'Creature Design', student: 'Emma Johnson' },
      { id: 6, image: '/Website/danny-mac-final-sq.jpg', title: 'Cartoon Character', student: 'Mike Rodriguez' },
      { id: 7, image: '/Website/831dab320fbaf8cad653d9e968992b76.jpg', title: 'Character Study', student: 'Lisa Brown' },
      { id: 8, image: '/Website/j-hill-hunter-posed-turn.jpg', title: 'Fantasy Warrior', student: 'Tom Wilson' },
      { id: 9, image: '/Website/pp.jpg', title: 'Warrior Squad', student: 'Anna Davis' },
      { id: 10, image: '/Website/anton-komarov-close-up-2.jpg', title: 'Portrait Study', student: 'Chris Garcia' },
    ],
  },
};
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <FilterHeroSection
        ...
        title="Master 3D Characters Sculpting in Blender for Games"
        subtitle="A 9-week course that guides students through the fundamentals of creating and sculpting a real-time character in 3D"
      />
      {/* Main Course Hero Section */}
      <CourseHero
        image={courseData.overview.image}
        title={courseData.overview.title}
        subtitle={courseData.overview.subtitle}
        description={courseData.overview.description}
        courseInfo={courseData.overview.courseInfo}
        assignment={courseData.overview.assignment}
        prerequisites={courseData.overview.prerequisites}
        tools={courseData.overview.tools}
        pricing={courseData.overview.pricing}
      />

      {/* Course Curriculum Section */}
      <CourseCurriculum
        title={courseData.curriculum.title}
        weeks={courseData.curriculum.weeks}
      />

      {/* Testimonials Section */}
      <Testimonials
        title={courseData.testimonials.title}
        testimonials={courseData.testimonials.testimonials}
        ratingBreakdown={courseData.testimonials.ratingBreakdown}
        overallRating={courseData.testimonials.overallRating}
        qualityMetrics={courseData.testimonials.qualityMetrics}
      />

      {/* Student Results Section */}
      <StudentResults
        title={courseData.studentResults.title}
        description={courseData.studentResults.description}
        studentWorks={courseData.studentResults.studentWorks}
      />
    </div>
  );
}