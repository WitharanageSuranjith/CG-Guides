...
import c1 from "@/assets/images/Img01.jpg";
import c2 from "@/assets/images/Img02.jpg";
import c3 from "@/assets/images/Img03.jpg";
  ...
  return (
    <section className="  bg-light w-full py-12 px-8">
      <div className="max-w-7xl mx-auto flex flex-col xl:flex-row items-center xl:items-start gap-8 ">
        ...
        {/* Right: Cards */}
        <div className="flex-1 flex flex-col sm:flex-row gap-10 justify-center w-full">
          {cards.map((card, idx) => (
            <div
              key={idx}
